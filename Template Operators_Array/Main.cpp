...
int main()
{
	...
	cout << "Создание массива INT Array a32 -= Array c (а содержит больше элементов массива с)\n";

	MyArray<int> a32(17);

	a32.FillArrayNoSrand();
	...
	cout << "Создание массива INT Array c -= Array a32 (c содержит меньше элементов массива a)\n";
	cout << "Массив а32: ";
	a32.print();
	...
	cout << "Сравнение на неравенство массива d с массивом c: ";
	result = d != c;
	cout << result << endl;
